...
#define CJK_UI_10_FONT_ID (288067014)
#define CJK_READER_14_FONT_ID (-212828678)
...
static_assert(CJK_UI_10_FONT_ID != 0, "Font ID collision with sentinel");
static_assert(CJK_READER_14_FONT_ID != 0, "Font ID collision with sentinel");
